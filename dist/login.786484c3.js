...
async function loginUser(options) {
  const response = await fetch("http://94.231.110.64:3000/api/user/login", options);
  const data = await response.json();
  const status = document.querySelector("#login-status");
  status.innerHTML = data.msg; //Return to frontpage if log in is successful
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","public/js/login.js"], null)
//# sourceMappingURL=/login.786484c3.js.map