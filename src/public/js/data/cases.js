exports.cases = [
  ...
  },
  {
    ...
    sites: [{ name: "Flensburg Fjord", data: [{name: "hej"}] }]
  },
  {
    name: "Danish case",
    sites: [
      { name: "The Oeresund", data: [{name: "hej", url: "https://94.231.110.64:8080/geoserver/AAU_Setup/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=AAU_Setup%3Aculturalheritage&maxFeatures=50000&outputFormat=application%2Fjson&srsname=EPSG:3857"}] },
  ...
  },
  {
    name: "Polish case",
    sites: [
      { name: "Puck Lagoon ", data: [{name: "hej"}] },
      { name: "Gulf of Gdansk", data: [{name: "hej"}] }
    ]
  },
  { name: "Lithuanian case", sites: [{ name: "Relict forest", data: [{name: "hej"}] }] },
  {
    name: "Russian case",
    sites: [
      {
